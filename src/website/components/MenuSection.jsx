...
const fallbackMenuItems = [
  ...
  },
  {
    ...
    id: "11",
    name: "Chimney Cake",
    description: "Transylvanian Chimney Cake spins sweet dough over fire, brushed with butter—caramelized outside, fluffy inside, a Hungarian street-food treasure.",
    price: 9.99,
    image: "/Pic_11.jpg",
    category: "Pastries and bakery",
    premium: true
    ...
    {
    id: "12",
    name: "Little Kolachie",
    description: "The Little Kolachie is a pillow enriched dough that has a sweet base with yeast leavened dough that is soft and chewy but sturdy enough to hold the filling.",
    price: 9.99,
    image: "/Pic_12.jpg",
    category: "Pastries and bakery",
    premium: true
    ...
    id: "13",
    name: "Dobos Cake",
    description: "Layers of sponge and chocolate buttercream crowned with caramel make Hungary’s elegant Dobos Cake a showpiece of flavor and artistry.",
    price: 9.99,
    image: "/Pic_13.jpg",
    category: "Pastries and bakery",
    premium: true
    ...
    {
    id: "14",
    name: "Hungarian Golden Pull-Apart Cake",
    description: "Hungarian monkey bread: yeasted dough balls rolled in sugar, walnuts, raisins, layered with apricot jam—a warm, festive indulgence.",
    price: 9.99,
    image: "/Pic_14.jpg",
    category: "Pastries and bakery",
    premium: true
    ...
    id: "15",
    name: "Apple Strudel",
    description: "Flaky puff pastry envelops apples and raisins, creating golden strudel—beautiful, aromatic, and surprisingly easy to prepare at home.",
    price: 9.99,
    image: "/Pic_15.jpg",
    category: "Pastries and bakery",
    premium: true
      ...
      {
    id: "16",
    name: "Hungarian Cold Soup Cucumber and Dill",
    description: "Layered sponge cake with chocolate buttercream and caramel top. A Hungarian dessert masterpiece.",
    price: 9.99,
    image: "/Pic_16.jpg",
    category: "Soups",
    premium: true
      ...
      {
    id: "17",
    name: "Clear Fish Soup",
    description: "Delicate broth of fresh fish, vegetables, herbs, and spices produces a light, refined soup, simple yet full of flavor.",
    price: 9.99,
    image: "/Pic_17.jpg",
    category: "Soups",
    premium: true
    ...
    id: "18",
    name: "Lentil Soup",
    description: "Hearty lentils, vegetables, and a splash of wine or lemon create comforting, wholesome soup, warming both body and spirit.",
    price: 9.99,
    image: "/Pic_18.jpg",
    category: "Soups",
    premium: true
    ...
    description: "Hungary’s national treasure, Goulash is a brothy stew-soup blend, rich with paprika flavor, hearty yet balanced, warming hearts worldwide.",
    price: 9.99,
    image: "/Pic_19.jpg",
    category: "Mains",
    premium: true
      ...
      {
    id: "20",
    name: "Hungarian Stuffed Cabbage Rolls",
    description: "Beef, rice, and tomato sauce rolled in cabbage leaves, baked to perfection, deliver a hearty, savory Hungarian family favorite.",
    price: 9.99,
    image: "/Pic_20.jpg",
    category: "Mains",
    premium: true
      ...
      {
    id: "21",
    name: "Hungarian Chicken Paprika",
    description: "Succulent chicken simmered in creamy paprika sauce makes Chicken Paprika an iconic Hungarian dish—warming, rich, and bursting with tradition.",
    price: 9.99,
    image: "/Pic_21.jpg",
    category: "Mains",
    premium: true
      ...
      {
    id: "22",
    name: "Hungarian Turos Csusza",
    description: "Hungarian Turos Csusza blends pasta, cottage cheese, and bacon bits or sugar topping, creating both savory comfort and sweet indulgence.",
    price: 9.99,
    image: "/Pic_22.jpg",
    category: "Mains",
    premium: true
      ...
      {
    id: "23",
    name: "Hungarian Stuffed Bell Peppers",
    description: "Stuffed bell pepper hides rice, beef, zucchini, onion, and tomatoes—an all-in-one hearty, colorful meal wrapped in flavorful vegetable goodness.",
    price: 9.99,
    image: "/Pic_23.jpg",
    category: "Mains",
    premium: true
      ...
      {
    id: "24",
    name: "Grilled Turkey Kebabs",
    description: "Tender turkey skewered, marinated, grilled, and smoked with herbs delivers a juicy kebab bursting with smoky charm and savory flavor.",
    price: 9.99,
    image: "/Pic_24.jpg",
    category: "Mains",
    premium: true
      ...
      {
    id: "25",
    name: "Hungarian French Salad",
    description: "Potatoes, peas, carrots, and apple combine into a creamy-crunchy Hungarian French salad, delightful as a barbecue side or standalone treat.",
    price: 9.99,
    image: "/Pic_25.jpg",
    category: "Salads",
    premium: true
      ...
      {
    id: "26",
    name: "Hungarian Seafood Salad",
    description: "Shrimp, crab, celery, onion, and dill tossed in creamy mayo with Old Bay spice make this seafood salad rich, irresistible.",
    price: 9.99,
    image: "/Pic_26.jpg",
    category: "Salads",
    premium: true
      ...
      {
    id: "27",
    name: "Hungarian Creamy Cucumber Salad",
    description: "Cool cucumber, crisp onion, and dill tossed in vinaigrette create a refreshing, soothing salad—perfect for hot summer days’ relief.",
    price: 9.99,
    image: "/Pic_27.jpg",
    category: "Salads",
    premium: true
      ...
      {
    id: "28",
    name: "Hungarian Pumpkin Muffins",
    description: "Hungarian Pumpkin Pie, a protein-rich cupcake, bursts with nutty aroma and sweet, spiced warmth in every delightful bite.",
    price: 9.99,
    image: "/Pic_28.jpg",
    category: "Pastries and bakery",
    premium: true
    ...
    id: "29",
    name: "Beetroot Juice",
    description: "rich in nitrates,supports lowerblood pressure, boosts athletic performance, and enhances cognitive function for overall health benefits.",
    price: 9.99,
    image: "/Pic_29.jpg",
    category: "Beverages",
    premium: true
    ...
    id: "30",
    name: "Carrot Juice",
    description: "rich in Vitamin A and potassium supports eye health, boosts immunity, and promotes healthy skin.",
    price: 9.99,
    image: "/Pic_30.jpg",
    category: "Beverages",
    premium: true
    ...
    id: "31",
    name: "Cucumber Juice",
    description: "with its high-water content of vitamins andminerals supports digestion, cardiovascular health, strong bones, clear skin,and mental wellbeing.",
    price: 9.99,
    image: "/Pic_31.jpg",
    category: "Beverages",
    premium: true
    ...
    id: "32",
    name: "Mango Juice",
    description: "rich in vitamins A and C, supports immunity, healthy skin, and helps maintain heart health effectively.",
    price: 9.99,
    image: "/Pic_32.jpg",
    category: "Beverages",
    premium: true
    ...
    id: "33",
    name: "Orange Juice",
    description: "juice, rich in Vitamin C, supports the immune system and heart health,",
    price: 9.99,
    image: "/Pic_33.jpg",
    category: "Beverages",
    premium: true
    ...
    id: "34",
    name: "Papaya Juice",
    description: "highly, supportive of digestion thanks to enzymes like papain and fiber that helps break down proteins and regulate the digestive system.",
    price: 9.99,
    image: "/Pic_34.jpg",
    category: "Beverages",
    premium: true
    ...
    id: "35",
    name: "Sangriya Juice",
    description: "A vibrant medley of fruit and wine, Sangria sparkles with citrusy sweetness, refreshing zest, and festive spirit in every sip.",
    price: 9.99,
    image: "/Pic_35.jpg",
    category: "Beverages",
    premium: true
    ...
    description: "it's keeps you hydrated while supporting muscle function and maintaining fluid balance.",
    price: 9.99,
    image: "/Pic_36.jpg",
    category: "Beverages",
    premium: true
    ...
    id: "37",
    name: "Avocado Juice",
    description: "rich in monounsaturated fats, supports cardiovascular function and promotes healthy vision.",
    price: 9.99,
    image: "/Pic_37.jpg",
    category: "Beverages",
    premium: true
    ...
    id: "38",
    name: "Tomato Juice",
    description: "juice, highly nutritious helps reduceinflammation, lower cholesterol, and decrease the risk of chronic diseases and cancers.",
    price: 9.99,
    image: "/Pic_38.jpg",
    category: "Beverages",
    premium: true
...
const MenuSection = ({ onAddToCart }) => {
  ...
  const categories = ["All", "Mains", "Soups", "Salads", "Beverages", "Desserts", "Sides", "Other"];
